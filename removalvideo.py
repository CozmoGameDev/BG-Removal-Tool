...
# Video settings
video_path: Const[str] = 'video.mp4'
video_output: Const[str] = 'nobackgroundvideo.mp4'
...
output_path = 'nobackgroundvideo.mp4'
...
def remove_background(image: Mat):
    ...
    masked_image = cv2.copyTo(image, mask, dst=masked_image)
